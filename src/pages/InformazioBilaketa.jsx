...
export default function InformazioBilaketa() {
  useDocumentTitle('Informazio Bilaketa Kritikoa');
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      <div className="bg-gradient-to-br from-teal-600 to-cyan-700 pt-20 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Informazio Bilaketa Kritikoa</h1>
        </div>
      </div>
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-slate-200 flex justify-between items-center">
          ...
          <Link to="/arazo-ebazpena" className="flex items-center gap-2 text-cyan-600 font-semibold text-sm hover:text-cyan-500">
            Arazo Ebazpena <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </div>
    </div>
