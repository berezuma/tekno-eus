...
export default function ProgramazioaSarrera() {
  useDocumentTitle('Programazioa eta AI Sarrera');
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      <div className="bg-gradient-to-br from-violet-500 to-purple-600 pt-20 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Programazioa eta AI Sarrera</h1>
        </div>
      </div>
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-slate-200 flex justify-between items-center">
          ...
          <Link to="/algoritmia" className="flex items-center gap-2 text-cyan-600 font-semibold text-sm hover:text-cyan-500">
            Algoritmia <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </div>
    </div>
