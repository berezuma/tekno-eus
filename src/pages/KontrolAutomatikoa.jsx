...
export default function KontrolAutomatikoa() {
  useDocumentTitle('Kontrol Automatikoa');
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      <div className="bg-gradient-to-br from-cyan-800 to-teal-900 pt-20 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          <Link to="/" className="text-white/70 text-sm hover:text-white mb-6 inline-block transition-colors">← tekno.eus</Link>
          <span className="text-white/70 text-sm font-medium uppercase tracking-wider block mb-3">Batxilergoa 1 · Automatikoa</span>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Kontrol Automatikoa</h1>
        </div>
      </div>
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-slate-200 flex justify-between items-center">
          ...
          <Link to="/robotika-bat" className="flex items-center gap-2 text-cyan-600 font-semibold text-sm hover:text-cyan-500">
            Robotika <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </div>
    </div>
