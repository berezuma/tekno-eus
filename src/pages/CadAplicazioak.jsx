...
export default function CadAplicazioak() {
  useDocumentTitle('CAD Aplikazioak (2D eta 3D)');
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      <div className="bg-gradient-to-br from-blue-500 to-cyan-600 pt-20 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">CAD Aplikazioak (2D eta 3D)</h1>
        </div>
      </div>
