...
export default function EnergiaIraunkorra() {
  useDocumentTitle('Energia Iraunkorra');
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      <div className="bg-gradient-to-br from-emerald-500 to-green-600 pt-20 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          <Link to="/" className="text-white/70 text-sm hover:text-white mb-6 inline-block transition-colors">← tekno.eus</Link>
          <span className="text-white/70 text-sm font-medium uppercase tracking-wider block mb-3">Batxilergoa 1 · Iraunkortasuna</span>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Energia Iraunkorra</h1>
        </div>
      </div>
