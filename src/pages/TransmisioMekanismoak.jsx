...
export default function TransmisioMekanismoak() {
  useDocumentTitle('Transmisio Mekanismoak');
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      <div className="bg-gradient-to-br from-amber-600 to-orange-700 pt-20 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          <Link to="/" className="text-white/70 text-sm hover:text-white mb-6 inline-block transition-colors">← tekno.eus</Link>
          <span className="text-white/70 text-sm font-medium uppercase tracking-wider block mb-3">Batxilergoa 1 · Mekanika</span>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Transmisio Mekanismoak</h1>
        </div>
      </div>
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-slate-200 flex justify-between items-center">
          ...
          <Link to="/zirkuitu-elektrikoak" className="flex items-center gap-2 text-cyan-600 font-semibold text-sm hover:text-cyan-500">
            Zirkuitu Elektrikoak <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </div>
    </div>
